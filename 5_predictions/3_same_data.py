...
if feature_set == 1:
    ...
    X = FMRI_FEATURES + EEG_MODEL_RESTING_FEATURES
    title = "FMRI+MODEL_RESTING"
elif feature_set == 13:
    X = EEG_ABCD_FEATURES
    title = "ABCD"
elif feature_set == 14:
    X = EEG_ABCD_FEATURES + EEG_MODEL_FEATURES
    title = "ABCD+MODEL"
elif feature_set == 15:
    X = EEG_VISUAL_FEATURES + EEG_MODEL_FEATURES
    title = "VISUAL+MODEL"
elif feature_set == 16:
    X = AGESEX_FEATURES + CLINICAL_FEATURES
    title = "CLINICAL"
else:
